      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            ?>
            <ul>
              <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 15) echo 'class="current-menu-item"'?>> <a href="<?php 
              echo esc_url(site_url( '/about-us' ));
              ?>">About Us</a></li>
              ...
              <?php if(is_user_logged_in(  )){ ?>
                <li <?php if (is_page('my-notes') or wp_get_post_parent_id(0) == 15) echo 'class="current-menu-item"'?>> <a href="<?php 
              echo esc_url(site_url( '/my-notes' ));
              ?>">My Notes</a></li>
               <?php }  ?>
            </ul>
          </nav>
