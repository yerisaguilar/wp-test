...
class MyNotes {
  ...
  editNote(e) {
    const thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li"); // const isclicked = true;
      ...
      this.resultsDiv.html(`
            <div class="row">
                <div class="one-third">
                    ...
                    <li>
                        <a href="${item.permalink}">${item.title} </a>${item.postType == "post" ? `by ${item.author}` : ""}
                    </li>`).join("")}
                ...
                <div class="one-third">
                    ...
                    ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No progams matches the search 
                    ...
                    ${results.profesors.length ? '<ul class="professor-cards">' : `<p>No professors matches the search 
                          </p>`}
                      ${results.profesors.map(item => `
                ...
                <div class="one-third">
                    ...
                    ${results.events.length ? '' : `<p>No events matches the search 
